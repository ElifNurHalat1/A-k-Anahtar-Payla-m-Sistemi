...
uint8_t alici_macadresi[] = {0xE8, 0xDB, 0x84, 0xE1, 0x6A, 0xF5};  
...
void VerilerAlindiginda(uint8_t * mac, uint8_t *incomingData, uint8_t len) {
  ...
  Serial.println(len);
  //alınan verileri değişkenlerimize atıyoruz4
...
void loop() {
  ...
  //eğer gelen cevap paketi içinde gelencevap değişkeni 1 ise ve
  if (gelencevap==true){
